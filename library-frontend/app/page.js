              ...
              <div className="w-full p-8 lg:w-1/2">
                ...
                {mode === 'signup' && (
                  <div className="mt-3 sm:mt-4">
                    ...
                    <input className="bg-gray-200 text-sm sm:text-base text-gray-700 h-9 sm:h-10 border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text" />
                  </div>
                )}

                <div className="mt-3 sm:mt-4">
                  <label className="block text-gray-700 text-[13px] sm:text-[15px] font-bold mb-2">Email Address</label>
                  <input className="bg-gray-200 text-sm sm:text-base text-gray-700 h-9 sm:h-10 border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" />
                </div>
                ...
                <div className="mt-3 sm:mt-4">
                  ...
                  <input className="bg-gray-200 text-sm sm:text-base text-gray-700 h-9 sm:h-10 border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="password" />
                </div>

                <div className="mt-6 sm:mt-8">
                  <button className="bg-gray-700 text-[13px] sm:text-[15px] text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">
