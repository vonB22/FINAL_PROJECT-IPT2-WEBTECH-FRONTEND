...
export default function DashboardPage() {
    ...
    return (
        <div className='py-[40px] px-[30px] h-screen pb-[50px] bg-zinc-950'>
            <div className="text-white text-2xl font-bold mb-6 pl-6">Dashboard</div>

            {/* {error && <div className="text-red-400 pl-6 mb-4">{error}</div>} */}

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 pr-[90px] text-white">
                <div className="bg-zinc-800 p-10 rounded-lg shadow">
